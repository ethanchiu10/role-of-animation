...
NAME="role-of-animation"
NODE_BIN_DIR=/usr/bin
NODE_PATH=/usr/local/lib/node_modules/
APPLICATION_DIRECTORY=/home/ubuntu/$NAME/
APPLICATION_START=server.coffee
...
start() {
  ...
  cd $APPLICATION_DIRECTORY
        /usr/local/bin/forever --pidFile $PIDFILE -c coffee --uid $NAME --sourceDir $APPLICATION_DIRECTORY \
...
stop() {
    ...
    /usr/local/bin/forever stop $NAME
                rm -f $PIDFILE
                RETVAL=$?
        else
